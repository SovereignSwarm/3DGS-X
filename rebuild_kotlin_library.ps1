...
Write-Host "=== Rebuilding PerseusCameraLib ===" -ForegroundColor Cyan

# Check if we're in the right directory
if (-not (Test-Path "PerseusCameraLib")) {
    Write-Host "Error: PerseusCameraLib directory not found!" -ForegroundColor Red
...
Push-Location PerseusCameraLib
try {
...
$aarPath = "PerseusCameraLib\app\build\outputs\aar\app-release.aar"
...
$unityPluginPath = "Assets\Plugins\Android\perseuscameralib.aar"
$backupPath = "Assets\Plugins\Android\perseuscameralib.aar.backup"
...
Write-Host "  3. Install on Quest: adb install -r Build\PerseusXR.apk" -ForegroundColor White
